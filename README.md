...
name = "Коля" - поле без аннотации, по умолчанию включается (Mode.YES)
age = 15 - поле без аннотации, по умолчанию включается (Mode.YES)
password = "0987" - поле с аннотацией @ToString(Mode.NO), исключается из вывода
...
<img width="1171" height="141" alt="Снимок экрана 2025-12-08 в 10 03 57" src="https://github.com/user-attachments/assets/613d89c2-ccea-4cb1-9ec1-e771d7f0e021" />
